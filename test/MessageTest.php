...
class MessageTest extends DevConnectTest {
	...
	public final function setUp() {
		...
		$this->sentProfileId = new Profile(null, "Q", "1234567", true, 1, null, "Hi, I'm Markimoo!", "foo@bar.com", "4018725372539424208555279506880426447359803448671421461653568500", "12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678", "Los Angeles", "Mark Fischbach", "1234567890123456789012345678901234567890123456789012345678901234");
		$this->sentProfileId->insert($this->getPDO());

		//create and insert a Profile to receive the test Message
		$this->receiveProfileId = new Profile(null, "T", "9876543", true, 2, null, "Hi, I'm Irelia!", "bar@foo.com", "4018725372539424208555279506880426447359803448671421461653568500", "12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678", "Ionia", "Irelia Ionia", "1234567890123456789012345678901234567890123456789012345678901234");
