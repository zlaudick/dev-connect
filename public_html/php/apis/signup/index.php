...
try {
	...
	if($method === "POST") {
		...
		$profile = new Profile(null, $requestObject->profileAccountType, "", $profileApproved, $profileApprovedById, $profileApprovedDateTime, null, $profileEmail, null, $hash, null, $profileName, $salt);
		$profile->insert($pdo);
